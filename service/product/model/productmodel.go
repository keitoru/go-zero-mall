...
type (
	...
	ProductModel interface {
		...
		TxAdjustStock(ctx context.Context, tx *sql.Tx, id int64, delta int64) (sql.Result, error)
	}
...
func (m *defaultProductModel) TxAdjustStock(ctx context.Context, tx *sql.Tx, id int64, delta int64) (sql.Result, error) {
